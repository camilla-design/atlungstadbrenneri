...
function Opplevelser(){
    return (
        ...
        <h1> - Opplevelser -</h1>
        <p>Her kan du se alle våre opplevelser! Enten du vil se hvordan potet blir til gylne dråper, bli med på omvisning eller andre oppelevlser</p>
