        ...
        <div className="mb-4 mt-4 image-gallery">
          <div className="responsive-gallery">
            <a target="_blank" rel="noreferrer" href={`${gallery.image[0].url}`}>
              <img src={`${gallery.image[0].url}`} width="600" alt="wedding" title="credit: Atlungstad Brenneri" />
            </a>
          </div>
        </div>
      ))}
        ...
        <div className="mb-4 mt-4 image-gallery">
          <div className="responsive-gallery">
            <a target="_blank" rel="noreferrer" href={`${gallery.image[1].url}`}>
              <img src={`${gallery.image[1].url}`} width="600" alt="wedding" title="credit: Atlungstad Brenneri" />
            </a>
          </div>
        </div>
      ))}
        ...
        <div className="mb-4 mt-4 image-gallery">
          <div className="responsive-gallery">
            <a target="_blank" rel="noreferrer" href={`${gallery.image[2].url}`}>
              <img src={`${gallery.image[2].url}`} width="600" alt="wedding" title="credit: Atlungstad Brenneri" />
            </a>
          </div>
        </div>
      ))}
        ...
        <div className="mb-4 mt-4 image-gallery">
          <div className="responsive-gallery">
            <a target="_blank" rel="noreferrer" href={`${gallery.image[3].url}`}>
              <img src={`${gallery.image[3].url}`} width="600" alt="wedding" title="credit: Atlungstad Brenneri" />
            </a>
          </div>
        </div>
      ))}
